...
import davigamer161.simplespawn.utils.UpdateChecker;
    ...
    public void saveMessages(){
      ...
      public void checkearMesages() {
          ...
          if(!texto.contains("update-checker:")) {
            getMessages().set("Messages.update-checker", "%plugin% &bThere is a new version &e(&f%latestversion%&e)&b. Download it here: &7https://www.spigotmc.org/resources/111086/");
            saveMessages();
          }
        } catch (IOException e) {
          e.printStackTrace();
		  ...
		  try {
	          ...
	          if (latestversion.length() <= 7) {
	        	  if(!version.equals(latestversion)){
	        		  ...
	        		  Bukkit.getConsoleSender().sendMessage(nombre+ChatColor.AQUA+"You can download it at: "+ChatColor.WHITE+"https://www.spigotmc.org/resources/111086/");  
	        	  }      	  
	          }
	      } catch (Exception ex) {
